...
/*@license
 *
 * ./servers/templates/rollbar.js is part of Tootsville
 *
 * Copyright   © 2008-2017   Bruce-Robert  Pocock;   © 2018-2021   The
 * Corporation for Inter-World Tourism and Adventuring (interworldly.com).
 *
...
var _rollbarConfig =
    { accessToken: "a3961b71531742a892080748e9da447e",
     captureUncaught: true,
      payload:
      { environment: "tootsville" } };
...
([function(r,e,o) {
  ...
  function(r,e) {
      ...
      function t(r,e,o) {
          ...
          r.uncaughtError.apply(r,o),e&&e.apply(window,o);};
      function n(r) {
          var e=function() {
      ...
      function i(r) {
          ...
          return o(function() {
              ...
              var o=this,t="scope"===r;
              t&&(o=new e(this));
              var n=Array.prototype.slice.call(arguments,0),a= {
                  shim:o,method:r,args:n,ts:new Date}
              ;
      ...
      a.init=function(r,e) {
          ...
          return o(function() {
              ...
              return e.captureUnhandledRejections&&(i._unhandledRejectionHandler=function(r) {
                  var e=r.reason,o=r.promise,t=r.detail;
      ...
      ,a.prototype.loadFull=function(r,e,t,n,a) {
          var i=function() {
              ...
              if(void 0===r._rollbarPayloadQueue) {
                  var o,t,n,i;
                  for(e=new Error("rollbar.js did not load");
                      o=r._rollbarShimQueue.shift();
                     )for(n=o.args,i=0;
                          i<n.length;
                          ++i)if(t=n[i],"function"==typeof t) {
                              t(e);
                              break}
              }
              "function"==typeof a&&a(e)}
          ,l=!1,c=e.createElement("script"),p=e.getElementsByTagName("script")[0],d=p.parentNode;
              ...
              if(!r._wrapped) {
                  r._wrapped=function() {
                      try {
                          ...
                          ,e._rollbarContext._wrappedSource=r.toString(),window._rollbarWrappedError=e,e;};
                  }
      ...
      ;
      for(var p="log,debug,info,warn,warning,error,critical,global,configure,scope,uncaughtError,unhandledRejection".split(","),d=0;
          d<p.length;
          ++d)a.prototype[p[d]]=i(p[d]);
      r.exports= {
          Rollbar:a,_rollbarWindowOnError:t;}
  }
  ,function(r,e) {
      "use strict";
      r.exports=function(r,e) {
          return function(o) {
              if(!o&&!window._rollbarInitialized) {
                  var t=window.RollbarNotifier,n=e|| {
                  }
                  ,a=n.globalAlias||"Rollbar",i=window.Rollbar.init(n,r);
