;;;; -*- lisp -*-
;;;
;;;; src/characters/named/rad.lisp is part of Tootsville
;;;
...
(defmethod initialize-robot ((robot robot) (Toot-name (eql :rad)))
  (initialize-robo-Toot robot))

(robo-Toot-heard* (rad nil)
  (robo-match ("rad")
    (robo-set-mode how-are-you)
    (robo-Toot-say robot "Hello, ~a. How are you?" (Toot-name speaker))))

(robo-Toot-heard* (rad how-are-you)
  (robo-match ("good")
