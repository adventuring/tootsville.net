;;;; -*- lisp -*-
;;;
;;;; src/characters/named/props.lisp is part of Tootsville
;;;
...
(defmethod initialize-robot ((robot robot) (Toot-name (eql :props)))
  (initialize-robo-Toot robot))

(robo-Toot-heard* (props nil)
  (robo-match ("props")
    (robo-set-mode how-are-you)
    (robo-Toot-say robot "Hello, ~a. How are you?" (Toot-name speaker))))

(robo-Toot-heard* (props how-are-you)
  (robo-match ("good")
