;;;; -*- lisp -*-
;;;
;;;; src/characters/named/superstar.lisp is part of Tootsville
;;;
...
(defmethod initialize-robot ((robot robot) (Toot-name (eql :superstar)))
  (initialize-robo-Toot robot))

(robo-Toot-heard* (superstar nil)
  (robo-match ("superstar")
    (robo-set-mode how-are-you)
    (robo-Toot-say robot "Hello, ~a. How are you?" (Toot-name speaker))))

(robo-Toot-heard* (superstar how-are-you)
  (robo-match ("good")
