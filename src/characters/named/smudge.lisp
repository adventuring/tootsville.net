;;;; -*- lisp -*-
;;;
;;;; src/characters/named/smudge.lisp is part of Tootsville
;;;
...
(defmethod initialize-robot ((robot robot) (Toot-name (eql :smudge)))
  (initialize-robo-Toot robot))

(robo-Toot-heard* (smudge nil)
  (robo-match ("smudge")
    (robo-set-mode how-are-you)
    (robo-Toot-say robot "Hello, ~a. How are you?" (Toot-name speaker))))

(robo-Toot-heard* (smudge how-are-you)
  (robo-match ("good")
