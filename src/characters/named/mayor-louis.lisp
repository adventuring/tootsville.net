...
(defmethod initialize-robot ((robot robot) (Toot-name (eql :mayor-louis)))
  (initialize-robo-Toot robot))

(robo-Toot-heard* (mayor-louis nil)
  (robo-match ("mayor-louis")
    (robo-set-mode how-are-you)
    (robo-Toot-say robot "Hello, ~a. How are you?" (Toot-name speaker))))

(robo-Toot-heard* (mayor-louis how-are-you)
  (robo-match ("good")
