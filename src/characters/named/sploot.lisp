;;;; -*- lisp -*-
;;;
;;;; src/characters/named/sploot.lisp is part of Tootsville
;;;
...
(defmethod initialize-robot ((robot robot) (Toot-name (eql :sploot)))
  (initialize-robo-Toot robot))

(robo-Toot-heard* (sploot nil)
  (robo-match ("sploot")
    (robo-set-mode how-are-you)
    (robo-Toot-say robot "Hello, ~a. How are you?" (Toot-name speaker))))

(robo-Toot-heard* (sploot how-are-you)
  (robo-match ("good")
