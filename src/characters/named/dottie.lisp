;;;; -*- lisp -*-
;;;
;;;; src/characters/named/dottie.lisp is part of Tootsville
;;;
...
(defmethod initialize-robot ((robot robot) (Toot-name (eql :dottie)))
  (initialize-robo-Toot robot))

(robo-Toot-heard* (dottie nil)
  (robo-match ("dottie")
    (robo-set-mode how-are-you)
    (robo-Toot-say robot "Hello, ~a. How are you?" (Toot-name speaker))))

(robo-Toot-heard* (dottie how-are-you)
  (robo-match ("good")
