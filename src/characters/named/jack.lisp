;;;; -*- lisp -*-
;;;
;;;; src/characters/named/jack.lisp is part of Tootsville
;;;
...
(defmethod initialize-robot ((robot robot) (Toot-name (eql :jack)))
  (initialize-robo-Toot robot))

(robo-Toot-heard* (jack nil)
  (robo-match ("jack")
    (robo-set-mode how-are-you)
    (robo-Toot-say robot "Hello, ~a. How are you?" (Toot-name speaker))))

(robo-Toot-heard* (jack how-are-you)
  (robo-match ("good")
