;;;; -*- lisp -*-
;;;
;;;; src/characters/named/nevermind.lisp is part of Tootsville
;;;
...
(defmethod initialize-robot ((robot robot) (Toot-name (eql :nevermind)))
  (initialize-robo-Toot robot))

(robo-Toot-heard* (nevermind nil)
  (robo-match ("nevermind")
    (robo-set-mode how-are-you)
    (robo-Toot-say robot "Hello, ~a. How are you?" (Toot-name speaker))))

(robo-Toot-heard* (nevermind how-are-you)
  (robo-match ("good")
