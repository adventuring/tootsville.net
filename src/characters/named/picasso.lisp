;;;; -*- lisp -*-
;;;
;;;; src/characters/named/picasso.lisp is part of Tootsville
;;;
...
(defmethod initialize-robot ((robot robot) (Toot-name (eql :picasso)))
  (initialize-robo-Toot robot))

(robo-Toot-heard* (picasso nil)
  (robo-match ("picasso")
    (robo-set-mode how-are-you)
    (robo-Toot-say robot "Hello, ~a. How are you?" (Toot-name speaker))))

(robo-Toot-heard* (picasso how-are-you)
  (robo-match ("good")
