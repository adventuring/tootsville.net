;;;; -*- lisp -*-
;;;
;;;; src/characters/named/sparkle.lisp is part of Tootsville
;;;
...
(defmethod initialize-robot ((robot robot) (Toot-name (eql :sparkle)))
  (initialize-robo-Toot robot))

(robo-Toot-heard* (sparkle nil)
  (robo-match ("sparkle")
    (robo-set-mode how-are-you)
    (robo-Toot-say robot "Hello, ~a. How are you?" (Toot-name speaker))))

(robo-Toot-heard* (sparkle how-are-you)
  (robo-match ("good")
