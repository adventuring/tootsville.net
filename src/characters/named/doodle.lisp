;;;; -*- lisp -*-
;;;
;;;; src/characters/named/doodle.lisp is part of Tootsville
;;;
...
(defmethod initialize-robot ((robot robot) (Toot-name (eql :doodle)))
  (initialize-robo-Toot robot))

(robo-Toot-heard* (doodle nil)
  (robo-match ("doodle")
    (robo-set-mode how-are-you)
    (robo-Toot-say robot "Hello, ~a. How are you?" (Toot-name speaker))))

(robo-Toot-heard* (doodle how-are-you)
  (robo-match ("good")
