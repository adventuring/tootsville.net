;;;; -*- lisp -*-
;;;
;;;; src/characters/named/moo.lisp is part of Tootsville
;;;
...
(defmethod initialize-robot ((robot robot) (Toot-name (eql :moo)))
  (initialize-robo-Toot robot))

(robo-Toot-heard* (moo nil)
  (robo-match ("moo")
    (robo-set-mode how-are-you)
    (robo-Toot-say robot "Hello, ~a. How are you?" (Toot-name speaker))))

(robo-Toot-heard* (moo how-are-you)
  (robo-match ("good")
