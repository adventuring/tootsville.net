;;;; -*- lisp -*-
;;;
;;;; src/characters/named/harmony.lisp is part of Tootsville
;;;
...
(defmethod initialize-robot ((robot robot) (Toot-name (eql :harmony)))
  (initialize-robo-Toot robot))

(robo-Toot-heard* (harmony nil)
  (robo-match ("harmony")
    (robo-set-mode how-are-you)
    (robo-Toot-say robot "Hello, ~a. How are you?" (Toot-name speaker))))

(robo-Toot-heard* (harmony how-are-you)
  (robo-match ("good")
