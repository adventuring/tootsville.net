...
(assert (equal "why am i shouting?"
	       (cassandra-obnoxious-filter "WHY AM I SHOUTING?")))
(assert (equal "One exclamation mark suffices!"
	       (cassandra-obnoxious-filter "One exclamation mark suffices!!!!")))
(assert (equal "Why can't people …"
	       (cassandra-obnoxious-filter "Why can't people ...")))
